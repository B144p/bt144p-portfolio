...
export const WAKA_SHARE_CONTRIBUTIONS_PATH = import.meta.env.VITE_WAKA_SHARE_CONTRIBUTIONS_PATH
...
export const WAKA_SHARE_CONTRIBUTIONS_URL = `${WAKA_SHARE_URL}${WAKA_SHARE_CONTRIBUTIONS_PATH}`
